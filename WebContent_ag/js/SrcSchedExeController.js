...
SADiagApp.controller('SrcSchedExeController', ['$scope', '$uibModal', '$http', '$log', function($scope, $uibModal, $http, $log) {
	                	  ...
	                	  $scope.statusTo = {
	    	                opened: false
    	                	  ...
    	                	  $scope.getSrcSchedExe = function () {
    	                		  //console.log('in getSrcSchedExe');
    	                		  $scope.srcFiles = [];
    	                		  $scope.srcFilesLoading = true;
    	                          $http({
    	                                  method : 'GET',
    	                                  url : "rest/sa/getSrcSchedExe/" + $scope.schedRulesEnv +'/' + $scope.fromDt + '/' + $scope.toDt
