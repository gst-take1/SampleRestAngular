...
<!-- angular-ui-select -->
<script src="./js/ajax/libs/angular-ui-select/0.20.0/select.min.js"></script>
<link rel="stylesheet" href="./js/ajax/libs/angular-ui-select/0.20.0/select.min.css"/>
<script>
sessionStorage.clickedTabId = 'myPub';
</script>
<style>
body {
	padding-top:120px;
...
<body ng-app="URLBuilderApp"  ng-controller="ModPubTemplateController">
	...
	<uib-progressbar ng-show="true" class="active progress-striped ng-cloak" value="100" type="primary">
		...
		<h5>Steps to build a Publication Template</h5>
		<div class="panel-group">
		    ...
		    <div class="panel panel-info">
	            <div class="panel-heading">
	                <h4 class="panel-title">
	                    <a data-toggle="collapse"  href="#stepTwo"><strong>2. Include or Exclude attributes from result (Optional)</strong></a>
	                </h4>
	            </div>
    							...
    							<table class="table table-hover table-condensed table-bordered table-striped">
                                    ...
                                    <tbody>
                                    	<tr ng-repeat="row in params">
								    		...
								    		<td class="col-md-3">
								    			<select ng-model="row.argValue" class="form-control">
	            ...
	            <div id="stepEight" class="panel-collapse collapse in">
	                <div class="panel-body">
						...
						<div class="form-group"  ng-class="{ 'has-error' : userForm.templateName.$invalid && !userForm.templateName.$pristine }">
							...
							<input type="text" ng-model="templateName" name="templateName" class="form-control" readonly/>
						...
						<div class="form-group">
							<button ng-click="savePub()" class="btn btn-primary" ng-disabled="userForm.$invalid">Save</button>
							<button ng-click="openSaveAs = !openSaveAs" class="btn btn-primary" >Copy</button>
							<button ng-click="deletePub()" class="btn btn-danger" ng-show="mode != 'readonly'">Delete</button>
						</div>
						...
						<div class="form-group">
						<button ng-click="savePub()" class="btn btn-primary" ng-show="openSaveAs" ng-disabled="userForm.$invalid">Save</button>
						</div>
						</div>
						<div class="form-group">
						<p>
